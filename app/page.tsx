...
import Image from "next/image";
 ...
 const features = [
  ...
  },
  {
    ...
    description:"Acess and chat with your PDFs seamlessly on any device, whether it's your device, whether it's your desktop, tablet, or smartphone.",
      ...
      <main className="flex-1 overflow-scroll p-2 lg:p5 bg-gradient-to-bl from-white to-indigo-600">
        <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl" >
            <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-600">
                    ...
                    questions, summarize content, and asnwer all your Qs. Idea for
            ...
            <div className="relative overflow-hidden pt-16">
              <div className="mx-auto max-w-7xl px-6 lg:px-8"><Image
                alt="App screenshot"
            ...
            lg:px-8">
              ...
              gap-y-10 text-base leading-7 text-green-600 sm:grid-cols-2
